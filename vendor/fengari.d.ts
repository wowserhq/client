...
// Loosely adapted from: https://github.com/fengari-lua/fengari/pull/157
declare module 'fengari' {
  const FENGARI_AUTHORS: string;
  const FENGARI_COPYRIGHT: string;
  const FENGARI_RELEASE: string;
  const FENGARI_VERSION: string;
  const FENGARI_VERSION_NUM: number;
  const FENGARI_VERSION_MAJOR: string;
  const FENGARI_VERSION_RELEASE: string;
  const FENGARI_VERSION_MINOR: string;
  ...
  function to_uristring(s: lua_String): string;
  ...
  namespace lua {
    ...
    type lua_Type = number;
    type lua_ArithOp = number;
    ...
    function lua_getinfo(L, what, ar): number;
    function lua_getlocal(L, ar, n): string;
    function lua_getstack(L, level, ar): number;
    ...
    function lua_pcallk(L: lua_State, nargs: number, nresults: number, errfunc: number, ctx: lua_KContext, k: lua_KFunction): number;
    function lua_pop(L: lua_State, n: number): void;
    function lua_pushboolean(L: lua_State, b: boolean | 0 | 1): void;
    ...
    function lua_setglobal(L: lua_State, name: lua_InputString): void;
  ...
  namespace lauxlib {
    ...
    function luaL_error(L: lua.lua_State, fmt: lua_InputString, ...args: any[]): number;
    ...
    function luaL_loadbuffer(L: lua.lua_State, buff: lua_InputString, size: number, name: lua_InputString): number;
